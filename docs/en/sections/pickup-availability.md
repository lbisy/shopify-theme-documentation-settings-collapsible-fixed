...
Use this section to add **Pickup Availability** content to a page.
...
![Pickup Availability settings and storefront preview](/images/en/pickup-availability.svg)
